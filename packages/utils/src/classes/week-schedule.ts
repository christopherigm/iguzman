...
//   private readDayValue(day: WeekDay, open: boolean = false): Time {
...
//       };
//     }
//     return open && this._days ? this._days.value[day].open : this._days.value[day].close ?? false;
//   }

//   private setDayValue(day: WeekDay, value: Time, open: boolean = false) {
//     if (this._days.value[day] === undefined) {
//       this._days.value[day] = {
//         open: this._defaultOpenTime,
//         close: this._defaultCloseTime,
