          ...
          columnSpacing={2}>
          {
            state.monday ?
              <TimeInput
                ...
                onChange={(name, value) => onDispatch(name, value)} /> : null
          }
          {
            state.tuesday ?
              <TimeInput
