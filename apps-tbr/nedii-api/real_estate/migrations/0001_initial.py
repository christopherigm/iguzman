# Generated by Django 4.1.9 on 2023-06-29 18:21
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(blank=True, choices=[('new', 'new'), ('like-new', 'like-new'), ('used', 'used')], default='new', max_length=16, null=True, verbose_name='Estado del inmueble')),
                ('year', models.CharField(blank=True, help_text='Anio del inmueble', max_length=4, null=True, verbose_name='Anio del inmueble')),
                ('area', models.PositiveSmallIntegerField(blank=True, default=60, null=True, verbose_name='Area')),
                ('num_of_bedrooms', models.PositiveSmallIntegerField(blank=True, default=1, null=True, verbose_name='Numero de recamaras')),
                ('num_of_bathrooms', models.PositiveSmallIntegerField(blank=True, default=1, null=True, verbose_name='Numero de banios')),
                ('num_of_parking_spots', models.PositiveSmallIntegerField(blank=True, default=1, null=True, verbose_name='Numero de cajones de estacionamiento')),
        ...
        migrations.AddField(
            model_name='realestate',
            name='stand',
            field=models.ForeignKey(help_text='Empresa al que pertenece este registro', on_delete=django.db.models.deletion.CASCADE, related_name='stand_real_estate', to='stand.stand', verbose_name='Empresa'),
        ),
    ]
