    ...
    <>
      ...
      >
        ...
        {/* `marginTop: auto` pins the title to the bottom of the flex column, so
            it reads as a footer whether the list is short or long. The collapse
            control sits at its right end - the one place in the sidebar that is
            always on screen no matter how long the list has grown. */}
        <Box
          marginTop="auto"
