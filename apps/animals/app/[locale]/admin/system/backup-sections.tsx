 ...
 * of this map is exactly how a section ends up labelled "Journal" in the picker
 * and "journal" in the list beside it.
 */
export const SECTION_LABELS: Record<BackupSection, string> = {
  settings: 'backupSectionSettings',
  catalog: 'backupSectionCatalog',
  journal: 'backupSectionJournal',
...
/**
 * The inline switch row both Backup and Restore pick their scope with.
 *
 * "All" is a control, not a section: turning it on selects every section and
 * locks the individual switches, which makes the common case (back up
...
function SwitchField({
  ...
  return (
    <Box alignItems="center" gap={8}>
      ...
      <Typography variant="body" color={disabled ? 'var(--muted-foreground, #6b7280)' : undefined}>
        {label}
      </Typography>
    </Box>
  );
