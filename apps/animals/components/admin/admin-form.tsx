...
// Status flags that belong above the form rather than buried at the bottom, in
// this display order. Any other boolean field renders in place.
//
// `enabled` is the draft/published switch every record here has; `is_featured`
// surfaces a record on the landing page. There is no stock or availability in a
// field journal, which is what website's list also carried.
