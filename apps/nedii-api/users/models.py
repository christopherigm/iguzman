...
class User(AbstractUser):
    ...
    favorite_items = models.ManyToManyField(
        'users.UserFavoriteBuyableItem',
        related_name='user_favorite_items',
        blank=True
    )
    cart_items = models.ManyToManyField(
        'users.UserCartBuyableItem',
        related_name='user_cart_items',
        blank=True
    )
    favorite_stands = models.ManyToManyField(
        'users.UserFavoriteStand',
        related_name='user_favorite_stands',
        blank=True
    )
