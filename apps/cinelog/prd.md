...
_Goal: Get the foundational environments running and talking to each other._
...
_Goal: Define the database schema and basic CRUD operations._
...
_Goal: Build the rapid-scanning UI and connect it to the backend._
...
_Goal: Connect the existing `scraper` microservice, a hosted LLM, and TMDB to autonomously resolve obscure barcodes._
...
_Goal: Build the human-in-the-loop interface to ensure data integrity._
