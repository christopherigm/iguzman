...
// Up to 3 page numbers, centered on the current page, clamped to [1, total].
// Near an edge the window slides so it stays full (e.g. page 1 -> 1,2,3;
// page N -> N-2,N-1,N) rather than shrinking.
  ...
  return (
    ...
    <div ref={anchorRef} style={{ height: docked ? undefined : barHeight }}>
      {/* While floating, pinned to the viewport bottom (bottom: 20px, tweak
          ...
          grid; centered and sized to fit its content (prev, up to 3 page
          buttons, next); a translucent, blurred surface keeps the buttons
