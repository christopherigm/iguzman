...
/**
 * "/about" for Tamara Tours - the long version of the story the landing's Intro
 * only teases: who takes you out, what the operation stands for (Mission /
 * Vision), and where to go next. Every word and the photo are the tenant's own
 * `System` fields, so the owner edits this page in the CMS and no copy is frozen
 * in the site folder. Served through the `[locale]/[...sitePath]` catch-all from
 * the site's `pages` map.
 *
  ...
  return (
    <>
      ...
      >
        ...
        {/* Where the story leads: the trips (only once there are any) and the
            shared /contact page, which already carries the marina address, the
            map, the phone numbers and the form. */}
