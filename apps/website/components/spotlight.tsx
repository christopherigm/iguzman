...
export async function Spotlight(section: LandingBlockProps = {}) {
  ...
  const title = pick(
    locale,
    system?.spotlight_title,
    system?.en_spotlight_title,
  );
  ...
  const label = pick(
    locale,
    system?.spotlight_label,
    system?.en_spotlight_label,
  );
