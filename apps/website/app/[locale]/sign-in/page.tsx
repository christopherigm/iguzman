...
const SYSTEM_ID = parseInt(process.env.NEXT_PUBLIC_SYSTEM_ID ?? '1', 10);
...
export default function SignInPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      const { access, refresh } = await login({ email, password, system_id: SYSTEM_ID });
  ...
  return (
    ...
    >
      ...
      >
        ...
        <p style={{ fontSize: 14, color: 'var(--muted-foreground, #6b7280)', marginBottom: 8 }}>
          {t('subtitle')}
        </p>
