...
export interface StoredVideo extends Omit<VideoResultFields, "isH265"> {
  ...
  /** Whether the H.264→H.265 conversion has been applied successfully. */
  h265Converted: boolean;
...
function applyDefaults(v: StoredVideo): StoredVideo {
  return {
    ...
    fulltitle: v.fulltitle ?? null,
    uploader_id: v.uploader_id ?? null,
    uploader_url: v.uploader_url ?? null,
