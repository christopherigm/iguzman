...
interface ServiceClassificationAttributesInterface extends BasePictureAttributesInterface {
  name: string;
  slug: string;
};
...
export interface ServicePictureInterface extends BasePictureAttributesInterface {
  id: number;
  type: 'ServicePicture';
  relationships: {
    stand: {
