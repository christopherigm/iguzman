...
export default class System extends BaseSystem {
  ...
  //           newItem.setNediiUserAttributesFromPlainObject(i);
  ...
  public getNediiPlainAttributes(): Object {
    return {
  ...
  public setNediiSystemAttributesFromPlainObject(props: any): void {
  ...
  public saveItemsToLocalStorage() {
    ...
    //       return {
    //         id: i.id,
    //         attributes: i.getNediiPlainAttributes(),
    //       };
    //     })
    //   : [];
