...
const PV_INVOKE = 'bash cli/play-videos/play-videos.sh [OPTIONS] <file|dir|playlist>';
...
export async function ToolsPanel() {
  ...
  return (
    <>
      {/* ─── edit-videos ─── */}
      <ScriptHeader title={t('toolsEvScriptTitle')} description={t('toolsEvScriptDesc')} />
      ...
      <EvSection
        ...
        code={EV_INVOKE}
      />
      <EvSection heading={t('toolsEvFlowHeading')} description={t('toolsEvFlowDescription')} />

      <GroupLabel>{t('toolsEvFiltersGroup')}</GroupLabel>

      <EvSection heading={t('toolsEvBlackBarsHeading')} description={t('toolsEvBlackBarsDesc')} />
      <EvSection heading={t('toolsEvFpsHeading')} description={t('toolsEvFpsDesc')} code={EV_FPS_PARAMS} />
      <EvSection heading={t('toolsEvH264Heading')} description={t('toolsEvH264Desc')} />
      <EvSection heading={t('toolsEvStabHeading')} description={t('toolsEvStabDesc')} code={EV_STAB_PARAMS} />
      <EvSection heading={t('toolsEvDenoiseHeading')} description={t('toolsEvDenoiseDesc')} code={EV_DENOISE_PARAMS} />
      <EvSection heading={t('toolsEvSharpenHeading')} description={t('toolsEvSharpenDesc')} code={EV_SHARPEN_PARAMS} />
      <EvSection heading={t('toolsEvUpscaleHeading')} description={t('toolsEvUpscaleDesc')} code={EV_UPSCALE_PARAMS} />
      <EvSection heading={t('toolsEvDownsizeHeading')} description={t('toolsEvDownsizeDesc')} code={EV_DOWNSIZE_PARAMS} />
      <EvSection heading={t('toolsEvColorHeading')} description={t('toolsEvColorDesc')} code={EV_COLOR_PARAMS} />
      <EvSection heading={t('toolsEvMpgHeading')} description={t('toolsEvMpgDesc')} />

      <GroupLabel marginTop={8}>{t('toolsEvAiGroup')}</GroupLabel>

      <EvSection heading={t('toolsEvRifeHeading')} description={t('toolsEvRifeDesc')} code={EV_RIFE_PARAMS} />
      <EvSection heading={t('toolsEvVideo2xHeading')} description={t('toolsEvVideo2xDesc')} code={EV_VIDEO2X_PARAMS} />
      <EvSection heading={t('toolsEvDeep3dHeading')} description={t('toolsEvDeep3dDesc')} code={EV_DEEP3D_PARAMS} />
      <EvSection heading={t('toolsEvTiktokHeading')} description={t('toolsEvTiktokDesc')} code={EV_TIKTOK_PARAMS} />

      <ScriptDivider />

      {/* ─── docker-cleanup ─── */}
      <ScriptHeader title={t('toolsDcSection')} description={t('toolsDcDescription')} />
      ...
      <EvSection
        ...
        code={DC_INVOKE}
      />
      <EvSection heading={t('toolsDcFlowHeading')} description={t('toolsDcFlowDescription')} />

      <GroupLabel>{t('toolsDcDockerOpsGroup')}</GroupLabel>

      <EvSection heading={t('toolsDcDanglingHeading')} description={t('toolsDcDanglingDesc')} />
      <EvSection heading={t('toolsDcOldHeading')} description={t('toolsDcOldDesc')} code={DC_OLD_PARAMS} />
      <EvSection heading={t('toolsDcAllUnusedHeading')} description={t('toolsDcAllUnusedDesc')} />
      <EvSection heading={t('toolsDcStoppedHeading')} description={t('toolsDcStoppedDesc')} />
      <EvSection heading={t('toolsDcCacheHeading')} description={t('toolsDcCacheDesc')} />
      <EvSection heading={t('toolsDcSystemPruneHeading')} description={t('toolsDcSystemPruneDesc')} />

      <ScriptDivider />

      {/* ─── play-videos ─── */}
      <ScriptHeader title={t('toolsPvSection')} description={t('toolsPvDescription')} />
      ...
      <EvSection
        ...
        code={PV_INVOKE}
      />
      <EvSection heading={t('toolsPvExamplesHeading')} description={t('toolsPvExamplesDescription')} code={PV_EXAMPLES} />
      <EvSection heading={t('toolsPvMediaHeading')} description={t('toolsPvMediaDesc')} code={PV_MEDIA_FLAGS} />
      <EvSection heading={t('toolsPvPlaybackHeading')} description={t('toolsPvPlaybackDesc')} code={PV_PLAYBACK_FLAGS} />
      <EvSection heading={t('toolsPvDisplayHeading')} description={t('toolsPvDisplayDesc')} code={PV_DISPLAY_FLAGS} />
      <EvSection heading={t('toolsPvAudioHeading')} description={t('toolsPvAudioDesc')} code={PV_AUDIO_FLAGS} />
      <EvSection heading={t('toolsPvAdvancedHeading')} description={t('toolsPvAdvancedDesc')} code={PV_ADVANCED_FLAGS} />

      <ScriptDivider />

      {/* ─── server-audit ─── */}
      <ScriptHeader title={t('toolsSaSection')} description={t('toolsSaDescription')} />
...
function EvSection({
  ...
  return (
    <Box flexDirection="column" gap={8} marginBottom={40}>
      <Typography as="h2" variant="h3">{heading}</Typography>
      <Typography as="p" variant="body-sm" color="var(--foreground-muted)">{description}</Typography>
      {code && <CodeBlock language="bash" code={code} />}
    </Box>
  );
}

function ScriptHeader({ title, description }: { title: string; description: string }) {
  return (
    <Box flexDirection="column" gap={8} marginBottom={40}>
      <Typography as="h2" variant="h2">{title}</Typography>
      <Typography as="p" variant="body" color="var(--foreground-muted)">{description}</Typography>
    </Box>
  );
}
