...
main() {
  ...
  # offered an MP4/MKV choice here - but MKV files produced by this profile did
  # not actually play on the test Samsung Smart TV (AVPlay refused them), while
  # the equivalent MP4 played fine. So MKV is intentionally NOT offered for the
  # Smart TV profile: it always outputs MP4. Revisit only with a device retest.
  OUTPUT_CONTAINER="source"
