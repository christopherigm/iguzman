...
setup_strings() {
  ...
  if [[ "${lang}" == "es" ]]; then
    ...
    ACTION_SMARTTV="Perfil Smart TV (Tizen) - H.265 en MP4/MKV, recorta bandas, audio apto para TV"
    SMARTTV_TIER_LABEL="Calidad Smart TV [1=SD 480p, 2=HD 720p, 3=FHD 1080p]"
    SMARTTV_INFO="Recorta bandas negras, escala a la resolución elegida, recodifica a H.265 y convierte el audio DTS/TrueHD a AC3 en un MP4 o MKV reproducible en la TV (tú eliges el contenedor; MP4 añade faststart + hvc1)"
    ...
    ACTION_SMARTTV="Smart TV (Tizen) profile - H.265 in MP4/MKV, crop bars, TV-friendly audio"
    SMARTTV_TIER_LABEL="Smart TV quality [1=SD 480p, 2=HD 720p, 3=FHD 1080p]"
    SMARTTV_INFO="Crops black bars, scales to the chosen resolution, re-encodes to H.265, and converts DTS/TrueHD audio to AC3 in a TV-playable MP4 or MKV (you pick the container; MP4 adds faststart + hvc1)"
